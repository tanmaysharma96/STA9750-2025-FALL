...
# THIS IS THE NEW CHUNK; Cleaning country table column names for Question 5 and interactive tables
...
# Step 1: Filtering TV shows from COUNTRY_TOP_10_CLEAN
tv_country <- COUNTRY_TOP_10_CLEAN %>%
  filter(Category == "TV", !is.na(Week))  # only valid weeks

# Step 2: Getting category/language from GLOBAL_TOP_10 safely
...
# Step 7: Highlighting Stranger Things
...
# Step 1: Filtering Hindi/non-English programs in India
...
# Step 2: Selecting top Hindi programs
...
# Step 3: Highlighting the top program
...
# Step 4: Plotting top Hindi programs in India with bold y-axis labels and colored top program
...
# Computing statistics in the code chunk
total_weeks_top5 <- sum(top_hindi$total_weeks)
#new section here
...
# Step 1: Preparing combined global data
...
# Step 2: Computing cumulative weeks in Top 10 by broad genre
...
# Step 4: Plotting top genres globally
...
# Step 5: Computing friendly numbers for markdown
